...
func TestBuildActions_InertControlRaisesAPriorityNowAction(t *testing.T) {
	...
	actions := buildActions(Coverage{}, nil, nil, PolicyAudit{}, controls, EvidenceQuality{}, ConfigDrift{})
...
func TestBuildActions_WiredControlsRaiseNothing(t *testing.T) {
	...
	if actions := buildActions(Coverage{}, nil, nil, PolicyAudit{}, controls, EvidenceQuality{}, ConfigDrift{}); len(actions) != 0 {
